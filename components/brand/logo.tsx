...
export function LogoMark({ className }: { className?: string }) {
  // Id unique par instance : le logo est rendu à la fois dans la sidebar (masquée < md) et la barre mobile ;
  // un id partagé pointerait vers le dégradient du SVG en `display:none`, qui ne se résout pas.
