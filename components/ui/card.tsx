  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Opt-in lift for clickable/hoverable cards (category chips, account
        // cards, goal cards, ...) — same recipe already proven in
        // settings/categories/page.tsx before this primitive existed there.
