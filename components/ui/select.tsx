  ...
  return (
    <div className="relative">
      <select
        data-slot="select"
        className={cn(
          "flex h-11 md:h-8 w-full min-w-0 appearance-none rounded-lg border border-input bg-background px-2.5 py-1 pr-7 text-base md:text-sm shadow-sm outline-none transition-[color,box-shadow] disabled:cursor-not-allowed disabled:opacity-50",
